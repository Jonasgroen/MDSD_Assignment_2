 ...
 *   <li>{@link dk.sdu.mmmi.mdsd.math.MulOrDiv#getOperator <em>Operator</em>}</li>
...
public interface MulOrDiv extends Exp
{
   ...
   * @see dk.sdu.mmmi.mdsd.math.MathPackage#getMulOrDiv_Operator()
   * @model
   * @generated
   */
  String getOperator();
  ...
  /**
   * Sets the value of the '{@link dk.sdu.mmmi.mdsd.math.MulOrDiv#getOperator <em>Operator</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
